...
#To find Gmail accounts with the latest and first signup date
SELECT 
...
#Calculate the difference in days between the latest and first signup dates
...
#Replace null values with '1970-01-01' for the signup_date column
UPDATE email_signup
